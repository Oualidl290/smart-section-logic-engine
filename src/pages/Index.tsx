                  ...
                  <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
                    <div className="space-y-4 max-w-2xl">
                      <div className="flex items-center gap-3">
                        <div className="p-3 rounded-xl backdrop-blur-sm bg-primary/20 border border-white/20">
                        ...
                        <div>
                          ...
                          <p className="text-xl font-medium text-white/90">
                            Free AI-powered dynamic content for everyone
                          </p>
                        </div>
                      </div>
                      <p className="text-lg leading-relaxed text-white/80">
                        Create unlimited intelligent content sections that automatically adjust based on user behavior, 
                        device type, location, and more. All features are completely free!
                      </p>
                    </div>
                    <div className="flex flex-col sm:flex-row gap-3">
                      ...
                      <Button 
                        ...
                        className="border-white/30 bg-white/10 hover:bg-white/20 h-12 px-8 font-semibold text-white border-2"
                      >
                ...
                <div className="flex items-center justify-between mb-6">
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Create and manage unlimited dynamic content sections with real-time analytics
                    </p>
                  </div>
                  <Button 
                    onClick={() => setIsCreateDialogOpen(true)} 
                ...
                {loading ? (
                  ...
                  <div className="text-center py-16">
                    ...
                    <p className="text-muted-foreground mb-8 max-w-md mx-auto leading-relaxed">
                      Get started by creating your first smart section. Build unlimited dynamic content that 
